...
export default function Speech() {
    ...
    const commands = [
        ...
        {
            command: 'weather is :condition today',
            callback: (condition) => setMessage(`Today, the weather is ${condition}`),
            isFuzzyMatch:true
        },
        {
            command: 'My top items are * and *',
            callback: (sport1, sport2) => setMessage(`ok I'll look for #1: ${sport1}, #2: ${sport2}`)
        },
        {
            command: 'Can I buy something',
